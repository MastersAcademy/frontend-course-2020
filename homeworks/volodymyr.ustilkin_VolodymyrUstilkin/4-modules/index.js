...
(function () {
    ...
    document.querySelector('[data-get-month-fridays-button]').addEventListener('click', () => {
    ...
    document.querySelector('[data-is-month-long-button]').addEventListener('click', () => {
        const date = new Date(document.querySelector('[data-main-task-input]').value);
        document.querySelector('[data-is-month-long-result]').innerText = time.isMonthLong(date);
    });

    document.querySelector('[data-get-month-shortest-week-button]').addEventListener('click', () => {
        const date = new Date(document.querySelector('[data-main-task-input]').value);
        document.querySelector('[data-get-month-shortest-week-result]').innerText = time.shortestWeekDaysNumber(date);
    });

    document.querySelector('[data-get-month-full-weeks-button]').addEventListener('click', () => {
        const date = new Date(document.querySelector('[data-main-task-input]').value);
