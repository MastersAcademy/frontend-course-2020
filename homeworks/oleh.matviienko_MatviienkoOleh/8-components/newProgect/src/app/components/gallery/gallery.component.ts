...
export class GalleryComponent implements OnInit {
  ...
  public array: any[] = [o, p, c, d, e, f, q, j, z, x, v, bone, n, m, q, w, r, t, y, u];
  ...
  public increasePicture(str: any) {
    const image = document.getElementById(str) as HTMLDivElement;
    const src: any = image.getAttribute('src');
    const bigPicture = document.getElementById('bigPicture') as HTMLDivElement;
    const all: any = document.querySelectorAll('.pictures');
