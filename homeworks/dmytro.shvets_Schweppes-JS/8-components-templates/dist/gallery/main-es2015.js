...
GalleryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GalleryComponent, selectors: [["app-gallery"]], decls: 5, vars: 2, consts: [[1, "h1"], [1, "container"], [1, "scroll-container"], ["class", "plate", 3, "image", "selected", "click", 4, "ngFor", "ngForOf"], [1, "plate", 3, "image", "click"]], template: function GalleryComponent_Template(rf, ctx) { if (rf & 1) {
