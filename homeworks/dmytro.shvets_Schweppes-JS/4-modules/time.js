...
function getFridaysOfMonth (date) {
  ...
  const amountDays = new Date(year, month + 1, 0).getDate(); // '0' means last day previous month , '+1' means next month after selected
...
export { getFridaysOfMonth, isMonthLong, shortestWeekDaysNumber, fullWeeksNumberInMonth };